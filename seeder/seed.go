...
func main() {
	...
	models.NewUser("test", "test@mail.com", "0812345678", "123321", "Test Account", "male", "8912830812387192837", "user", -7.391283, 122.781239) // 1
	models.NewUser("test1", "test1@mail.com", "0812345678", "123321", "Test Account 1", "female", "8912830812387192837", "user", -7.391283, 122.781239)

	models.NewUser("admin", "admin@mail.com", "0812345678", "123321", "Test Account Admin", "female", "8912830812387192837", "admin", -7.391283, 122.781239)                // 2

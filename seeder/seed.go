...
func main() {
	...
	models.NewUser("test", "test@mail.com", "0812345678", "123321", "Test Account", "male", "8912830812387192837")                                                          // 1
	models.NewUser("test1", "test1@mail.com", "0812345678", "123321", "Test Account 1", "female", "8912830812387192837")                                                    // 2
